# Dockerfile — Corrigido (Ajuste no CMD)
...
# Copia todo o projeto para /app (incluindo a pasta server/)
COPY . /app

EXPOSE 10000

# CORREÇÃO: Aponta para o caminho real do server.py dentro do container: server/server.py
