...
# A pasta do projeto inteiro está em /app no container.
# -----------------------------------------------------------
PROJECT_ROOT = Path("/app") 
UI_PUBLIC = PROJECT_ROOT / "web" / "ui" / "public"

# Ensure folders must be created relative to the /app
...
def create_app():
    ...
    # ----------------------------------------------------------------------
    # ROTA ESTÁTICA CORRIGIDA para servir /ui/ (index.html, dashboard.html, assets/)
    # ----------------------------------------------------------------------
    if UI_PUBLIC.exists():
